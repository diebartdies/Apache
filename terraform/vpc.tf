...
# NAT Gateway so private tasks can reach the internet (e.g. pip installs)
...
# Apache ECS task — only reachable from the ALB
resource "aws_security_group" "apache" {
  name        = "${var.app_name}-apache-sg"
  description = "Apache/web.py Fargate task"
  vpc_id      = aws_vpc.main.id
  ...
  tags = { Name = "${var.app_name}-apache-sg" }
}

# RDS — only reachable from Apache tasks
